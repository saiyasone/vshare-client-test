                ...
                <Mui.GenerateLinkArea>
                  <Grid container gap={6}>
                    ...
                    <FormControl sx={{ width: "40%"}}>
                      <FormControlLabel control={<Checkbox id="allowDownload" name="allowDownload" checked={values.allowDownload} onChange={handleChange} />} label="Allow Download" />
                      <FormControlLabel control={<Checkbox id="allowUpload" name="allowUpload" checked={values.allowUpload} onChange={handleChange} />} label="Allow Upload" />
                      <FormControlLabel control={<Checkbox id="allowMultiples" name="allowMultiples" checked={values.allowMultiples} onChange={handleChange} />} label="Allow Multiples" />
                    </FormControl>
                    </Box>
                    </Grid>
